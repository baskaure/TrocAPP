  ...
  return (
    <div className="relative min-h-[calc(100dvh-5.5rem)] w-full">
      ...
      <div className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div className="flex flex-col items-center justify-center rounded-xl bg-secondary-container p-8 text-center md:col-span-4 md:p-10">
              <span
          ...
          {filteredByMonth.map((proposal) => {
                ...
                return (
                  <div
                    ...
                    className={`glass-card flex cursor-pointer items-center justify-between rounded-lg border border-white/50 p-6 transition-all duration-300 hover:shadow-lg ${
