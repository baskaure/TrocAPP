    ...
    <footer className="mt-20 w-full border-t border-outline-variant/15 bg-surface-container-low py-12">
      <div className="mx-auto flex max-w-screen-2xl flex-col items-center justify-center gap-6 px-4 sm:px-6 md:px-8">
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          <span className="cursor-default text-xs font-inter uppercase tracking-widest text-on-surface-variant/70">Confidentialité</span>
          <span className="cursor-default text-xs font-inter uppercase tracking-widest text-on-surface-variant/70">Conditions</span>
          <a
            href="mailto:contact@bontroc.fr"
            className="text-xs font-inter uppercase tracking-widest text-on-surface-variant/70 transition-colors hover:text-primary"
          >
            Contact
          </a>
        </div>
